<div class="uk-width-3-4 uk-margin-auto">
    <div class="uk-form-horizontal uk-margin-large">
        ...
        <div class="uk-margin uk-flex uk-flex-column">
            <label for="your-c-address"><span class="uk-label uk-margin-small-right">任意</span>企業・団体のご住所</label>
            <div class="uk-form-controls" style="margin:0;">
        ...
        <div class="uk-margin uk-flex uk-flex-column">
            <label for="your-c-email"><span class="uk-label uk-margin-small-right">必須</span>連絡先1（任意）企業・団体の連絡先</label>
            <div class="uk-form-controls" style="margin:0;">
        ...
        <div class="uk-margin uk-flex uk-flex-column">
            <label for="your-tel"><span class="uk-label uk-margin-small-right">必須</span>連絡先2（必須）参加される方の携帯番号</label>
            <div class="uk-form-controls" style="margin:0;">
        ...
        <div class="uk-margin uk-flex uk-flex-column">
            ...
            <div class="uk-form-controls uk-form-controls-text" style="margin:0;">
                [radio inquiry-type id:inquiry-type use_label_element "男性" "女性" "答えたくない"]
            </div>
        </div>

        <div class="uk-margin uk-flex uk-flex-column">
            <label for="your-message"><span class="uk-label uk-margin-small-right">必須</span>業種</label>
            <div class="uk-form-controls" style="margin:0;">
