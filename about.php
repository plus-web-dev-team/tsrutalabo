...
<main>
    ...
    <section class="uk-section uk-background-default" id="about_main-header">
        <div class="uk-container">
            ...
            <div>
                <div class="uk-grid uk-child-width-1-1 uk-child-width-1-2@s uk-grid-medium uk-margin-large-bottom" uk-grid>
                    <div>
                ...
                <div class="uk-grid uk-child-width-1-1 uk-child-width-1-2@s uk-grid-medium" uk-grid>
                    <div>
    ...
    <section class="uk-section" id="about_main-body">
        <div class="uk-container">
            <div class="uk-grid uk-child-width-1-1 uk-child-width-1-3@s uk-grid-medium uk-grid-match uk-margin-large-bottom" uk-grid>
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image08.svg" alt="" class="uk-width-expand">
                ...
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image09.svg" alt="" class="uk-width-expand">
                    <h3 class="uk-text-bolder">多種多様な選択肢を補いあう環境を提供します！</h3>
                    <p class="uk-margin-remove-top">関わる人たち全員が自分の価値を実感しながら地域を動かしていける場所を目指します。</p>
                </div>
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image10.svg" alt="" class="uk-width-expand">
    ...
    <section class="uk-section uk-background-default" id="about_main-header">
        <div class="uk-container">
            ...
            <div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding" uk-grid>
                    <div class="uk-width-1-6">会社名</div>
                    <div class="uk-width-expand">一般社団法人もったいない研究所</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">登記住所</div>
                    <div class="uk-width-expand">鶴田町大字鶴田字前田10-6</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">事務所所在地</div>
                    <div class="uk-width-expand">鶴田町大字妙堂崎字杉元75 1階運営室</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">電話番号</div>
                    <div class="uk-width-expand">0173-26-5888（FAX兼）</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">メールアドレス</div>
                    <div class="uk-width-expand">mottainai.research@gmail.com</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">代表者</div>
                    <div class="uk-width-expand">岡 詩子</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">設立</div>
                    <div class="uk-width-expand">令和6年</div>
                </div>
                <div class="uk-grid uk-child-width-1-2 uk-border-solid uk-padding uk-margin-remove-top" uk-grid>
                    <div class="uk-width-1-6">事業内容</div>
