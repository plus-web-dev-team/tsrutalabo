...
<main>
        ...
        <div class="uk-container">
            <div class="uk-grid uk-grid-small uk-child-width-1-1 uk-child-width-1-2@m" uk-grid>
                ...
                <div class="uk-width-3-4 uk-width-expand@m uk-margin-auto">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_header_image01.svg" alt="事業紹介のヘッダー画像" class="uk-width-expand">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="uk-section uk-background-default" id="about_main-header">
        <div class="uk-container uk-position-relative">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image01.svg" alt="つるたん" class="uk-position-small uk-position-top-right uk-visible@m">
            ...
            <div class="uk-flex uk-flex-middle uk-flex-column uk-flex-row@m uk-margin-large-bottom">
                <div class="uk-margin-bottom uk-margin-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image02.png" alt="スチューベンの紹介画像" class="uk-width-expand">
                </div>
                <div class="uk-margin-left">
                    <p class="uk-text-bolder uk-margin-remove">鶴田町の気候が生んだ芳醇な甘みとコクを誇る</p>
                    <h3 class="uk-text-bolder uk-margin-small-top">「スチューベン」</h3>
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image03.svg" alt="スチューベンのイラスト" class="uk-align-right">
                </div>
            </div>
            <div class="uk-flex uk-flex-middle uk-flex-column-reverse uk-flex-row@m uk-margin-large-bottom">
                <div class="uk-margin-right">
                    <p class="uk-text-bolder uk-margin-remove">シャキシャキとした食感と絶妙な甘さを持つ</p>
                    <h3 class="uk-text-bolder uk-margin-small-top">「鶴田町のりんご」</h3>
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image04.svg" alt="りんごのイラスト" class="uk-align-right">
                </div>
                <div class="uk-margin-left uk-margin-bottom">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image05.png" alt="りんごの紹介画像" class="uk-width-expand">
                </div>
            </div>
            <div class="uk-flex uk-flex-middle uk-flex-column uk-flex-row@m uk-margin-large-bottom">
                <div class="uk-margin-bottom uk-margin-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image06.png" alt="鶴田町産のお米の紹介画像" class="uk-width-expand">
                </div>
                <div class="uk-margin-left">
                    <p class="uk-text-bolder uk-margin-remove">肥沃な土地と清らかな水で育まれた</p>
                    <h3 class="uk-text-bolder uk-margin-small-top">「鶴田町産の美味しいお米」</h3>
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image07.svg" alt="お米のイラスト" class="uk-align-right">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="uk-section" id="about_main-body">
        <div class="uk-container">
            <div class="uk-grid uk-child-width-1-1 uk-child-width-1-3@s uk-grid-medium uk-grid-match uk-margin-large-bottom" uk-grid>
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image08.svg" alt="ミッション-地域住民の活き活きとした生活イメージ" class="uk-width-3-4 uk-margin-auto">
                ...
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image09.svg" alt="ビジョン-多様な選択肢を補い合う環境のイメージ" class="uk-width-3-4 uk-margin-auto">
                    <h3 class="uk-text-bolder">多種多様な選択肢を補いあう環境を提供します！</h3>
                    <p class="uk-margin-remove-top">関わる人たち全員が自分の価値を実感しながら地域を動かしていける場所を目指します。</p>
                </div>
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image10.svg" alt="バリュー-もったいないの探究イメージ" class="uk-width-3-4 uk-margin-auto">
    ...
    <section class="uk-section uk-background-default" id="about_main-footer">
        <div class="uk-container">
            ...
            <div class="uk-width-1-1">
                <img src="<?php echo get_template_directory_uri(); ?>/images/page_about_main_image11.svg" alt="運営会社概要のロゴ" class="uk-width-expand">
            </div>
