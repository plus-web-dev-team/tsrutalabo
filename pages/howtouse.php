...
<main>
    ...
    <section class="uk-section uk-background-default" id="rhowtouse_main">
        <div class="uk-container uk-container-large">
            ...
            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider="sets: true; autoplay: true; autoplay-interval: 3000">
                ...
                <ul class="uk-flex uk-flex-center uk-slider-nav uk-dotnav uk-margin-medium"></ul>
