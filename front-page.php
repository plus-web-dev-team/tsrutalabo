...
<main>
    <section class="uk-section" id="hero">
        <div class="uk-container uk-container-large">
            <img src="<?php echo get_template_directory_uri(); ?>/images/hero_image.svg"
                alt="TSURUTA LABOメイン画像" class="uk-width-expand">
        </div>
    </section>
    ...
    <section class="uk-section uk-background-default" id="news">
        ...
        <div class="uk-align-center uk-text-center">
            <a class="uk-button uk-button-default uk-text-uppercase uk-border-rounded"
                href="<?php echo home_url("news"); ?>">read more</a>
        </div>
    </section>
        ...
        <div class="uk-container">
            ...
            <div class="uk-grid uk-child-width-1-1 uk-child-width-1-2@m uk-grid-small uk-grid-match" uk-grid>
                ...
                <div class="uk-line-height uk-letter-spacing">
                    <p>鶴田町地域活性化支援センター（愛称：TSURUTA LABO）は、<span
                            class="uk-text-lead">地域の活性化</span>と<span
                            class="uk-text-lead">持続的な発展</span>を支援するため、新しい事業の創出をサポートし、地域産業およびコミュニティ活動の成長・振興に貢献することを目的としています。TSURUTA
                        LABOは、廃校となった<span class="uk-text-lead">旧鶴田町立水元中央小学校</span>を活用し、貸オフィス、コワーキングスペース、イベントスペース、シェアショップなどを備えた<span
                            class="uk-text-lead">多機能施設</span>として<span
                            class="uk-text-lead">生まれ変わりました</span>。</p>
                    <div class="uk-text-center">
                        <a class="uk-button uk-button-default uk-text-uppercase uk-border-rounded"
                            href="<?php echo home_url("about"); ?>">read more</a>
                    </div>
                </div>
    ...
    <section class="uk-section uk-background-default" id="facility">
        <div class="uk-container">
            ...
            <div class="uk-align-center uk-width-fit uk-margin-large-bottom">
                <p class="uk-width-3-4@m uk-align-center">鶴田町地域活性化支援センター（愛称：TSURUTA
                    LABO）は、旧鶴田町立水元中央小学校の建物をリノベーションし、多様な用途に対応できる複合施設として整備されています。
                    地域内外の利用者がビジネスやコミュニティ活動に活用できる環境を提供し、地域産業の振興と住民同士の交流を促進します。</p>
            </div>
            <div class="uk-grid uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-4@m uk-grid-small uk-grid-match"
                uk-grid>
                <div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/facility_image01.svg" alt=""
                        class="uk-width-1-2 uk-width-expand@m uk-align-center">
                    <p class="uk-text-center uk-text-lead">貸オフィス</p>
                    <p class="uk-margin-remove-top">
                        地域外の企業や事業者が、地域の拠点として業務を行える専用オフィススペースを提供。リモートワークや地方での事業拠点として利用可能です。</p>
                </div>
                <div>
                    ...
                    <p class="uk-margin-remove-top">
                        フリーランス、起業家、リモートワーカーが自由に利用できる共有オフィススペース。様々な分野の人々が集い、アイデアを共有し、コラボレーションを促進します。</p>
                </div>
                <div>
                    ...
                    <p class="uk-margin-remove-top">
                        セミナーやワークショップ、地域イベント、展示会など、様々な用途に対応可能な多目的スペース。地域住民や企業が自由に利用でき、交流や学びの場を提供します。</p>
                </div>
                <div>
                    ...
                    <p class="uk-margin-remove-top">
                        地元の特産品や手工芸品を販売・展示するスペース。地域のクリエイターや生産者が自分の商品を紹介し、販路を広げるためのプラットフォームとして利用できます。</p>
                </div>
            </div>
        </div>
        <div class="uk-align-center uk-text-center">
            <a class="uk-button uk-button-default uk-text-uppercase uk-border-rounded"
                href="<?php echo home_url("facility"); ?>">read more</a>
        </div>
    </section>
    ...
    <section class="uk-section" id="howtouse">
        <div class="uk-container uk-margin-large-bottom">
            ...
            <div class="uk-align-center uk-text-center">
                <a href="<?php echo home_url("howtouse"); ?>"><img
                        src="<?php echo get_template_directory_uri(); ?>/images/howtouse_button.svg"
                        alt="施設のご利用方法ページへ" class="uk-width-auto"></a>
            </div>
        </div>
    </section>
    ...
    <section class="uk-section uk-background-default" id="residence">
        <div class="uk-container">
            ...
            <div class="uk-align-center uk-width-fit uk-align-center">
                <p class="uk-width-3-4@m uk-align-center">鶴田町地域活性化支援センター（愛称：TSURUTA
                    LABO）では、様々な分野で活動する法人や個人が活動しています。それぞれが独自のビジネスや活動を展開し、地域と連携しながら新たな価値を創出しています。ここでは、現在入居している利用者をご紹介します。</p>
            </div>
                ...
                ?>
                        <div>
                            <div class="uk-margin-bottom uk-position-relative">
                                ...
                                if (!empty($image)) : ?>
                                    <div class="uk-image-ornament"><img src="<?php echo esc_url($image['url']); ?>"
                                            alt="<?php echo esc_attr($image['alt']); ?>" />
                                    </div>
                                <?php else : ?>
                                    <div class="uk-image-ornament"><img
                                            src="<?php echo esc_url(get_template_directory_uri() . '/images/page_residence_header_noimage.svg'); ?>"
                            ...
                            <div>
                                ...
                                <div class="uk-margin-small-bottom">
                                    <?php if ($site = get_field("custom_site")) : ?>
                                        <a href="<?php echo esc_url($site); ?>" uk-icon="icon: world"
                                            target="_blank" rel="noopener noreferrer"></a>
                                    <?php endif; ?>
                                    <?php if ($twitter = get_field("custom_twitter")) : ?>
                                        <a href="<?php echo esc_url($twitter); ?>" uk-icon="icon: twitter"
                                            target="_blank" rel="noopener noreferrer"></a>
                                    <?php endif; ?>
                                    <?php if ($facebook = get_field("custom_facebook")) : ?>
                                        <a href="<?php echo esc_url($facebook); ?>" uk-icon="icon: facebook"
                                            target="_blank" rel="noopener noreferrer"></a>
                                    <?php endif; ?>
                                    <?php if ($instagram = get_field("custom_instagram")) : ?>
                                        <a href="<?php echo esc_url($instagram); ?>" uk-icon="icon: instagram"
                                            target="_blank" rel="noopener noreferrer"></a>
                                    <?php endif; ?>
                                </div>
                                <?php if ($google_map = get_field("custom_google_map")) : ?>
                                    <p><a href="<?php echo esc_url($google_map); ?>" class="uk-border-solid">Google
                                            Map</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div class="uk-align-center uk-text-center">
            <a class="uk-button uk-button-default uk-text-uppercase uk-border-rounded"
                href="<?php echo home_url("residence"); ?>">read more</a>
        </div>
    </section>
