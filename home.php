            ...
            <div class="uk-container uk-container-small">
                ...
                if ($query->have_posts()) :
                    while ($query->have_posts()) : $query->the_post();
                        ...
                        ?>
                        <article
                                id="post-<?php the_ID(); ?>" <?php post_class('uk-flex uk-flex-column uk-flex-row@s uk-flex-left uk-flex-middle@s uk-margin-medium-bottom uk-border-dashed uk-padding-small'); ?>>
